...
### GLOBAL CONFIG
### ======================
##USD_INR = 83.0   # approx USD → INR (acceptable for prototype)
##
##
### ======================
### PAGE 1 : USER INFO
...
##def get_gold_10gm():
##    """
##    COMEX Gold (USD/oz) → INR / 10 gm
##    """
##    try:
##        gold_usd_oz = yf.Ticker("GC=F").history(period="1d")["Close"].iloc[-1]
##        gold_inr_10gm = (gold_usd_oz * USD_INR / 31.1035) * 10
##        return round(gold_inr_10gm, 2)
##    except:
##        return 62000   # realistic fallback
##
##
##def get_silver_kg():
##    """
##    COMEX Silver (USD/oz) → INR / kg
##    """
##    try:
##        silver_usd_oz = yf.Ticker("SI=F").history(period="1d")["Close"].iloc[-1]
##        silver_inr_kg = (silver_usd_oz * USD_INR) / 0.0311035
##        return round(silver_inr_kg, 2)
##    except:
##        return 72000   # realistic fallback
##
##
### ======================
...
##
##    # ---------- Commodity Prices ----------
##    gold_price = get_gold_10gm()     # ₹ / 10 gm
##    silver_price = get_silver_kg()   # ₹ / kg
##
##    # ---------- Chart Data (simple + stable) ----------
...
##
##        # deterministic but non-fixed choice
##        sector_map = {
